    ...
    class MapHandler
    {
        ...
        public MapHandler(string filename)
        {
            ...
            try
            {
                ...
                char[,] MapFromFile = new char[height, width];
        ...
        public void showMap()
        {
            int meret1 = this.map.GetLength(0);
            int meret2 = this.map.GetLength(1);
            for (int row = 0; row < meret1; row++)
            {
                for (int col = 0; col < meret2; col++)
                {
